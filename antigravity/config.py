...
# ─── LiteLLM Proxy (OpenAI-compatible, routes to Ollama/Kimi/etc.) ──
LITELLM_BASE_URL = os.getenv("OPENAI_API_BASE", "http://127.0.0.1:4000")
LITELLM_API_KEY = os.getenv("LITELLM_API_KEY", "ollama-local")
...
# LiteLLM Proxy models (served via http://127.0.0.1:4000)
LITELLM_MODEL_QWEN = "ollama-qwen"      # Qwen via LiteLLM proxy
LITELLM_MODEL_MISTRAL = "ollama-mistral"  # Mistral via LiteLLM proxy (fallback)
