...
# With 16GB RAM we can run ONE 14B model at a time, or TWO 7B in parallel.
# Strategy: run agents sequentially with 14B for quality,
#           or in pairs with 7B for speed.
