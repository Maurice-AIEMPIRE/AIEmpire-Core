...
- **Roles**:
  - **Maurice**: CEO/Visionary (20% strategic oversight)
  - **Claude**: Chief Architect/CSO (Build & Security)
  - **Kimi/Ollama**: Execution Agents (Research, Content)
